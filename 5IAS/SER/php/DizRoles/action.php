        ...
        <div class="row justify-content-center align-middle h-100">
            <div class="col-10 align-self-center">
                <div class="jumbotron shadow p-3 mb-5 rounded">
                    <?php 
                        ...
                        elseif($option == "put"){
                            ...
                            if(!isset($temp)){
                                ...
                                $dictionary[$word]["meaning"] = $tmpMeaning;
                                $dictionary[$word]["userId"] = $_SESSION["id"];
                        ...
                        elseif($option == "post"){
                            $temp = $dictionary[$word];
                            if(isset($temp)){
                                if($dictionary[$word]["userId"] == $_SESSION["id"]){
                                    $tmpMeaning = $_POST["meaning"];
                                    $dictionary[$word]["meaning"] = $tmpMeaning;
                                    $dictionary = json_encode($dictionary);
                                    file_put_contents($fileName,"$dictionary");
                                    ...
                                    $meaning = "You don't have the permission to modify this word";
                                }
                            }
                            else{
                                $meaning = "Sorry, word not found";
                        ...
                        elseif($option == "delete"){
                            ...
                            if(isset($temp)){
                                if($dictionary[$word]["userId"] == $_SESSION["id"]){
                                    ...
                                    $meaning = "You don't have the permission to delete this word";
                                }
                            }
                            else{
                                $meaning = "Sorry, word not found";
                    ...
                    <hr class='my-4'>
                    <button type="button" class="btn btn-secondary btn-sm" onclick="document.location.href='dizionario.php'">Return</button>
                </div>
            </div>
        </div>
    </div>
